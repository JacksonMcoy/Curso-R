...
\item Grafica la distribuci\'on normal de inter\'es entre $\pm 4\sigma$ y sombrea  el \'area de probabilidad del \'item , el $10$ por ciento m\'as lento de los estudiantes en completar la pregunta.
\end{itemize}
